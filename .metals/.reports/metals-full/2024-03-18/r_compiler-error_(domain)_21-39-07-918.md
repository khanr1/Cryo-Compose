file://<WORKSPACE>/01-domain/src/main/scala/com/khanr1/cryocompose/wiring/rf/RfAssembly.scala
...
action parameters:
offset: 720
uri: file://<WORKSPACE>/01-domain/src/main/scala/com/khanr1/cryocompose/wiring/rf/RfAssembly.scala
text:
```scala
package com.khanr1
package cryocompose
...
/** Representation for a RF assembly
  ...
  */
final case class RfAssembly[AssemblyID, ConnectorID](
    id: AssemblyID,
    connectors: List[RfConnector[ConnectorID]],
    lines: List[RfLine[ConnectorID]]
) extends WiringAssembly(connectors, lines)
    with Product[AssemblyID, String :| Not[Empty], String:|Not[Empty],Descriptio[@@]]
