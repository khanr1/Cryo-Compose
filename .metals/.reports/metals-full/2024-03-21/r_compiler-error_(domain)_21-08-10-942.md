file://<WORKSPACE>/01-domain/src/main/scala/com/khanr1/cryocompose/Categories.scala
...
action parameters:
offset: 913
uri: file://<WORKSPACE>/01-domain/src/main/scala/com/khanr1/cryocompose/Categories.scala
text:
```scala
package com.khanr1
package cryocompose
...
/** A Categorie allow to regroup product into families
  ...
  */
final case class Categories[CategoryID](
  id: CategoryID,
  name: CategoryName,
