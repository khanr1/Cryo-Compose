file://<WORKSPACE>/01-domain/src/main/scala/com/khanr1/cryocompose/Tag.scala
...
action parameters:
offset: 664
uri: file://<WORKSPACE>/01-domain/src/main/scala/com/khanr1/cryocompose/Tag.scala
text:
```scala
package com.khanr1
package cryocompose
...
/** Tag  can be added to a product for meta information
  *
  * @param id
  ...
  */
final case class Tag[TagID](id: TagID, name: TagName) derives Eq
